...
공식 사용 스킬은 [공개 저장소의 스킬 안내](https://github.com/schift-io/knowledge-scope#use-with-a-coding-agent)에서 설치 경로를 확인하세요. 사용자가 지정한 자료 연결, 연결 ID 재사용, 근거 검색과 출처 제시를 안내하는 입구입니다. npm 패키지 설치만으로 AI 도구에 스킬이 자동 등록되지는 않습니다.
